...
PMESH_L15_PCX_ILA::PMESH_L15_PCX_ILA()
    : // construct the model
      ...
      threadid  (model.NewBvInput("transducer_l15_threadid", 1)),
      val       (model.NewBvInput("transducer_l15_val",      1)),
      amo_op    (model.NewBvInput("transducer_l15_amo_op",   4)), // pcxdecoder_l15_amo_op L15_AMO_OP_WIDTH
      invalidate(model.NewBvInput("transducer_l15_invalidate_cacheline", 1)), // pcxdecoder_l15_invalidate_cacheline
