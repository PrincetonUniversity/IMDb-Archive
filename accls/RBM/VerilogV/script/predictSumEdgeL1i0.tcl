...
assume { ( cycles[0] |-> 1 ) }
assume { ( cycles[1] |-> 1 ) }
assume { ( cycles[2] |-> acc_0.state_rbm_0_cmos32soi_rbm_predict_rbm[16] ) }
assume { ( cycles[3] |-> acc_0.state_rbm_0_cmos32soi_rbm_predict_rbm[17] ) }
assume { ( cycles[4] |-> acc_0.state_rbm_0_cmos32soi_rbm_predict_rbm[19] ) }
assume { ( cycles[5] |-> ( acc_0.state_rbm_0_cmos32soi_rbm_predict_rbm[20] && acc_0.state_rbm_0_cmos32soi_rbm_predict_rbm_next[19] )) }
...
# pre-match
assume { (cycles[3] |-> ( GM.predict_sum == acc_0.mux_sum_ln400_z ) ) }
assume { (cycles[3] |-> ( GM.predict_v_cnt == acc_0.mux_v_ln388_q ) ) }
assume { (cycles[3] |-> ( GM.predict_h_cnt == acc_0.mux_h_ln400_z ) ) }  
assume { (cycles[3] |-> ( GM.predict_max == {acc_0.mux_rem_ln58_q[10:0], 
...
assume { (cycles[3] |-> ( GM.jstate == acc_0.mux_j_ln423_z ) ) } 
...
# load_info
assume { ( cycles[4] |->  ( reg0 == acc_0.mux_j_ln423_z ) )   }
# final-check
