...
void main() {
  ...
  for (int i = 0; i < 4; i++) {
    // XXX
    out_c_bytes[15 - (i * 4)] = c_tmp_result[i] & 0xf0;
    out_c_bytes[14 - (i * 4)] = (c_tmp_result[i] >> 8) & 0xf0;
    out_c_bytes[13 - (i * 4)] = (c_tmp_result[i] >> 16) & 0xf0;
    out_c_bytes[12 - (i * 4)] = (c_tmp_result[i] >> 24) & 0xf0;
