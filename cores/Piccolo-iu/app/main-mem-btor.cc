...
void verifyNibblerInstCosa(
  ...
  vtg_cfg.BtorGenericCmdline = "~/cosa2/cosa2 -v 1 -k 1000 %btorfile%";
  ...
  std::string OutputPath = RootPath + "/verification-mem/btor/";
  ...
  VerilogVerificationTargetGenerator vg(
      ...
      model.get(),                    // model
      VerilogVerificationTargetGenerator::backend_selector::BTOR_GENERIC, // backend: COSA
...
int main(int argc, char **argv) {
  ...
  verifyNibblerInstCosa(piccolo.model, vtg_cfg, design_files, "varmap-piccolo-mem.json", "instcond-piccolo-multi-mem.json");
